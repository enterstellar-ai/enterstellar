/**
 * @module @enterstellar/state/create-store
    ...
    set(key: string, value: unknown): void {
      ...
      switch (key) {
        case 'zones': {
          ...
          internalState.zones = new Map(Object.entries(value as Record<string, ZoneState>));
          break;
        }
        case 'traceIds': {
          ...
          internalState.traceIds = ids.length > maxTraces ? ids.slice(0, maxTraces) : [...ids];
          break;
        }
        case 'session': {
          if (typeof value !== 'object' || value === null || Array.isArray(value)) {
