/**
 * @module @enterstellar/state/__tests__/integration/persistence
...
import type { ZoneState, SerializedState } from '@enterstellar/types';
 ...
 */
function createSharedMemoryAdapter(storage: Map<string, SerializedState>): PersistenceAdapter {
  const KEY = 'state';
  return {
