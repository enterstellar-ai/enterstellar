...
/**
 * @module @enterstellar/react/defaults/enterstellar-error-card
 ...
 * @example
 * ```tsx
 * import { EnterstellarErrorCard } from '@enterstellar/react';
 *
...
export function EnterstellarErrorCard(props: EnterstellarErrorCardProps): React.JSX.Element {
  ...
  return (
    ...
    >
      ...
      {/* Error message */}
      <p style={ERROR_MESSAGE_STYLES}>{error.message}</p>
