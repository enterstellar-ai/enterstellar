...
/**
 * @module @enterstellar/react/lifecycle-wrapper
 ...
 *    `EnterstellarEmptyState`) shipped with `@enterstellar/react` (LC8).
 *
...
import type { LifecycleState } from '@enterstellar/lifecycle';
 ...
 * renderer is found, the default components ship with `@enterstellar/react` (LC8).
 *
