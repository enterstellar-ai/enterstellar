/**
 * @module @enterstellar/react/__tests__/enterstellar-provider.test
 ...
 * Mirrors the `RenderCache` interface from `@enterstellar/cache`.
 */
function mockCache() {
 ...
 * Mirrors the `EnterstellarAdapters` interface from `@enterstellar/adapters`.
 */
