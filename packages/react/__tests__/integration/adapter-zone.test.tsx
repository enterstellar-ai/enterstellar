/**
 * @module @enterstellar/react/__tests__/integration/adapter-zone.test
...
function createAdapterMocks() {
  ...
  const compiler = {
    compile: vi.fn(
      async (): Promise<CompilationResult> => ({
        status: 'fail' as const,
        componentName: 'FailComponent',
        props: {},
        errors: [
          { code: 'ENS-2001', path: 'root', message: 'Intentional failure for adapter testing' },
        ],
