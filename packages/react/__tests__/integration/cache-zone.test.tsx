/**
 * @module @enterstellar/react/__tests__/integration/cache-zone.test
...
describe('Cache + Zone Integration', () => {
  ...
  it('compiles normally when cache is null (CA3 passthrough)', async () => {
    ...
    render(
      ...
      >
        <Zone name="no-cache-zone" fallback={<div data-testid="loading">Loading</div>} />
      </Provider>,
    );
  ...
  it('compiles on cache MISS and stores result in cache (CA2)', async () => {
    ...
    render(
      <Provider
        ...
        cache={mocks.cache}
      >
        <Zone name="miss-zone" fallback={<div data-testid="loading">Loading</div>} />
      </Provider>,
    );
  ...
  it('skips compilation on cache HIT and renders from cached result (CA1)', async () => {
    ...
    render(
      <Provider
        ...
        cache={mocks.cache}
      >
        <Zone name="hit-zone" fallback={<div data-testid="loading">Loading</div>} />
      </Provider>,
    );
  ...
  it('creates ZoneTrace on cache HIT with correct metadata (L4)', async () => {
    ...
    render(
      <Provider
        ...
        cache={mocks.cache}
      >
        <Zone name="trace-zone" fallback={<div>Loading</div>} />
      </Provider>,
    );
