/**
 * @module @enterstellar/react/__tests__/integration/lifecycle-zone.test
  ...
  it('transitions to ready state and renders compiled component', async () => {
    ...
    render(
      <Provider
        ...
        connection={mocks.connection}
      >
        <Zone name="ready-zone" fallback={<div data-testid="loading">Loading</div>} />
      </Provider>,
    );
  ...
  it('renders the second component when two intents arrive quickly (P14)', async () => {
    ...
    render(
      <Provider
        ...
        connection={mocks.connection}
      >
        <Zone name="p14-zone" fallback={<div>Loading</div>} />
      </Provider>,
    );
