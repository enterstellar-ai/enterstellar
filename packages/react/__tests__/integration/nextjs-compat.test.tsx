/**
 * @module @enterstellar/react/__tests__/integration/nextjs-compat
 * @description Next.js App Router compatibility test for `@enterstellar/react`.
 *
...
/**
 * Root source directory of `@enterstellar/react`.
    ...
    it('Zone renders loading state without accessing browser globals', () => {
      ...
      const { container } = render(
        <Provider
          ...
          telemetry={mocks.telemetry}
        >
          <Zone name="ssr-zone" fallback={<div data-testid="ssr-fallback">Loading...</div>} />
        </Provider>,
      );
