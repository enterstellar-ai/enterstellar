/**
 * @module @enterstellar/react/__tests__/hooks/use-enterstellar-trace.test
...
describe('useEnterstellarTrace()', () => {
  ...
  it('throws when used outside Provider', () => {
    ...
    }).toThrow('useEnterstellarTrace() must be used within an <Provider>.');
  ...
  it('returns the latest trace for the specified zone', () => {
    const traces = [makeTrace('test-zone', 'trace-old'), makeTrace('test-zone', 'trace-new')];
  ...
  it('returns single trace when only one exists for zone', () => {
    const store = createMockStore([makeTrace('test-zone', 'only-trace')]);
