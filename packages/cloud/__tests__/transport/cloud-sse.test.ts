/**
 * @module @enterstellar/cloud/__tests__/transport/cloud-sse.test
 ...
 */
function mockSSEResponse(events: string[], ipuHeaders: Record<string, string> = {}): Response {
...
describe('@enterstellar/cloud — CloudSSETransport', () => {
  ...
  describe('429 Pre-Stream (SD3)', () => {
    it('throws CloudError on 429 before yielding any fragments', async () => {
      ...
      await expect(
        collectFragments(sseTransport.stream({ body: { intent: 'vitals' }, isAnonymous: false })),
