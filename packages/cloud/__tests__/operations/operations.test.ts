/**
 * @module @enterstellar/cloud/__tests__/operations/operations.test
...
describe('@enterstellar/cloud — CertifyProxy', () => {
...
describe('@enterstellar/cloud — DataDeletionProxy', () => {
  let transport: CloudHttpTransport;
  let tracker: IPUTracker;
...
describe('@enterstellar/cloud — TracesQueryProxy', () => {
  let transport: CloudHttpTransport;
  let tracker: IPUTracker;
...
describe('@enterstellar/cloud — LedgerQueryProxy', () => {
  let transport: CloudHttpTransport;
  let tracker: IPUTracker;
