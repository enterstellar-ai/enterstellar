/**
 * @module @enterstellar/cloud/__tests__/inference/cloud-forge-proxy.test
...
function createMockTransport(response: CloudResponse<ComponentContract>): CloudHttpTransport {
  return {
...
function createMockSSETransport(fragments: ForgeFragment[] = []): CloudSSETransport {
  return {
    stream: vi.fn().mockReturnValue(
      (async function* (): AsyncGenerator<ForgeFragment, void, undefined> {
...
describe('@enterstellar/cloud — CloudForgeProxy', () => {
