/**
 * @module @enterstellar/cloud/__tests__/inference/cloud-index-proxy.test
...
type SearchServerResponse = {
  readonly results: readonly { componentName: string; score: number }[];
};
...
describe('@enterstellar/cloud — CloudIndexProxy', () => {
