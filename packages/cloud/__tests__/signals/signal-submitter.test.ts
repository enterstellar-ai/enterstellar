/**
 * @module @enterstellar/cloud/__tests__/signals/signal-submitter.test
...
describe('@enterstellar/cloud — SignalSubmitter', () => {
  ...
  describe('Anonymous Mode (SD1, SD4)', () => {
    it('works in anonymous mode — no throw', async () => {
      const anonSubmitter = createSignalSubmitter(transport, tracker, true, 'app');
      (transport.request as ReturnType<typeof vi.fn>).mockResolvedValue(MOCK_RESPONSE);
