/**
 * @module @enterstellar/cloud/create-cloud-client
 * @description Factory function for creating the Enterstellar Cloud SDK client.
 *
 * This is the top-level entry point of `@enterstellar/cloud`. It validates the
...
import { createAnonymousModeError, createConfigError, createDisposedError } from './errors.js';
...
/**
 * Creates an {@link EnterstellarCloudClient} — the primary public API of `@enterstellar/cloud`.
 *
...
export function createEnterstellarCloudClient(config: CloudConfig): EnterstellarCloudClient {
  ...
  const signalSubmitter = createSignalSubmitter(transport, tracker, isAnonymous, sessionType);
