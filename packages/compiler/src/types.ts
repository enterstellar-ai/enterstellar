/**
 * @module @enterstellar/compiler/types
 * @description Compiler-local type definitions.
 *
 * These types are internal to `@enterstellar/compiler` and define the configuration,
 ...
 * `@enterstellar/telemetry`. The compiler defines this locally to avoid
 ...
 * `@enterstellar/telemetry` via structural typing.
 *
...
export interface EnterstellarCompiler {
   ...
   */
  compile(intent: ComponentIntent, options?: CompileOptions): Promise<CompilationResult>;
   ...
   * Used by `@enterstellar/test` for assertions and CI pipelines.
   *
