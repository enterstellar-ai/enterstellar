/**
 * @module @enterstellar/compiler/__tests__/correction-integration
...
describe('Tier 1 → Tier 2 Cascade', () => {
  it('#1 — each tier works on shrinking error set', () => {
    ...
    const result = attemptDeterministicCorrection(errors, { age: '72' }, contract, EMPTY_TOKENS);
  ...
  it('#5 — zero errors → zero corrections, corrected=true', () => {
    ...
    const result = attemptDeterministicCorrection([], { title: 'Hello' }, contract, EMPTY_TOKENS);
