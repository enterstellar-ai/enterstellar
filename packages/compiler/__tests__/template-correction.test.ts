/**
 * @module @enterstellar/compiler/__tests__/template-correction
...
describe('Tier 2: Template Correction', () => {
  it('#10 — empty examples → Tier 2 skipped (corrected: false)', () => {
    ...
    const errors: CompilationError[] = [createMissingFieldError('category')];
  ...
  it('#11 — stale examples (fail safeParse) → Tier 2 skipped', () => {
    ...
    const errors: CompilationError[] = [createMissingFieldError('score')];
