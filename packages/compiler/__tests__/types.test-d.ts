/**
 * @module @enterstellar/compiler/__tests__/types
...
import type { CompilationResult, CompilationError, ComponentIntent } from '@enterstellar/types';
...
describe('EnterstellarCompiler type', () => {
  it('has compile() returning Promise<CompilationResult>', () => {
    expectTypeOf<
      EnterstellarCompiler['compile']
    >().returns.resolves.toEqualTypeOf<CompilationResult>();
  });

  it('has lint() returning Promise<readonly CompilationError[]>', () => {
    expectTypeOf<EnterstellarCompiler['lint']>().returns.resolves.toEqualTypeOf<
      readonly CompilationError[]
    >();
  });
...
describe('CompilationStep signature', () => {
  it('is a function taking (context, next) and returning Promise<CompilationContext>', () => {
    ...
    expectTypeOf<CompilationStep>().parameters.toEqualTypeOf<
      [CompilationContext, () => Promise<CompilationContext>]
    >();
