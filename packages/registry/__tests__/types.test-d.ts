/**
 * @module @enterstellar/registry/__tests__/types
...
import type { ComponentContract, CompactManifestEntry, DesignTokenSet } from '@enterstellar/types';
...
describe('Registry type assignability', () => {
  it('EnterstellarRegistry.get() returns ComponentContract | undefined', () => {
    expectTypeOf<EnterstellarRegistry['get']>().returns.toEqualTypeOf<
  ...
  it('EnterstellarRegistry.getManifest() returns readonly CompactManifestEntry[]', () => {
    expectTypeOf<EnterstellarRegistry['getManifest']>().returns.toEqualTypeOf<
      readonly CompactManifestEntry[]
    >();
  });

  it('EnterstellarRegistry.getSchema() returns z.ZodType | undefined', () => {
    expectTypeOf<EnterstellarRegistry['getSchema']>().returns.toEqualTypeOf<
      z.ZodType | undefined
    >();
  });
