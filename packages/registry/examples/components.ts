/**
 * @module @enterstellar/registry/examples
  ...
  examples: [
    {
      ...
      props: {
        ...
        message: 'Warfarin + Aspirin detected. Review immediately.',
        dismissible: false,
      },
    },
  ],
...
export const PatientHeader = defineComponent({
  ...
  accessibility: {
    role: 'banner',
    ariaLabel: 'Patient information header',
...
export const VitalsChart = defineComponent({
  ...
  props: z.object({
    patientId: z.string(),
    metrics: z.array(
      z.enum(['heartRate', 'bloodPressure', 'temperature', 'oxygenSaturation', 'respiratoryRate']),
    ),
  ...
  examples: [
    {
      ...
      props: {
        ...
        body: 'Last checked: 2 minutes ago',
        variant: 'elevated',
      },
    },
  ],
