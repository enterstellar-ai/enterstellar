/**
 * @module @enterstellar/test/__tests__/coverage
...
describe('computeIntentCoverage()', () => {
  ...
  describe('partial coverage', () => {
    ...
    it('rounds percentage to 2 decimal places', () => {
      const registry = createRegistry({
        components: [createComponent('Alpha'), createComponent('Beta'), createComponent('Gamma')],
      });

      const results: TestResultRecord[] = [result('show alpha', 'Alpha')];
