/**
 * @module @enterstellar/test/__tests__/assertions
...
describe('tokenCompliant', () => {
  ...
  it('throws ENS-5004 when ENS-2002 errors exist', () => {
    const result = mockResult({
      errors: [{ code: 'ENS-2002', path: 'tokens.color', message: 'Hallucinated token: #ff0000' }],
    });
...
describe('accessibilityToPass', () => {
  ...
  it('throws ENS-5006 when ENS-2003 errors exist', () => {
    const result = mockResult({
      errors: [{ code: 'ENS-2003', path: 'accessibility.role', message: 'Missing ARIA role' }],
    });
  ...
  it('error message includes violation details', () => {
    const result = mockResult({
      errors: [{ code: 'ENS-2003', path: 'accessibility.ariaLabel', message: 'Missing ariaLabel' }],
    });
