/**
 * @module @enterstellar/test/create-test-harness
 * @description Factory function for creating the Enterstellar test harness.
 *
 * `createTestHarness()` wires together:
 * - A real `EnterstellarCompiler` (from `@enterstellar/compiler`) with `strategy: 'reject'`
 ...
 *
 * The harness uses the real `@enterstellar/compiler` for validation but replaces
