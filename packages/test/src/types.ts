/**
 * @module @enterstellar/test/types
 * @description Module-local type definitions for `@enterstellar/test`.
 *
...
import type { AgentTrace, CompilationResult, ComponentIntent } from '@enterstellar/types';
 ...
 *
 * Each method checks a condition and throws `EnterstellarError` (module: `@enterstellar/test`)
...
export interface EnterstellarTestHarness {
   ...
   * 2. Compile via real `@enterstellar/compiler`
