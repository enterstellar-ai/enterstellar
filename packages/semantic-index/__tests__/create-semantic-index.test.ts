/**
 * @module @enterstellar/semantic-index/__tests__/create-semantic-index
...
import { z } from 'zod';
import { EnterstellarError, createComponentId } from '@enterstellar/types';
import type { ComponentContract, ComponentCategory } from '@enterstellar/types';
...
function createTestContract(name: string, category: string, tags: string[]): ComponentContract {
  return {
