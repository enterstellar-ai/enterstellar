/**
 * @module @enterstellar/semantic-index/types
 ...
 *
 * **L15 compliance:** Zero framework imports. Pure TypeScript + `@enterstellar/types`.
 *
 * @see Implementation Bible §4.7
 * @see Design Choices SI1–SI12
 */

import type { CompactManifestEntry, SemanticSearchResult } from '@enterstellar/types';
