/**
 * @module @enterstellar/lifecycle/types
 ...
 *
 * These types are re-exported from `@enterstellar/lifecycle`'s barrel but are
 * NOT re-exported from `@enterstellar/types` — they are internal to this module.
 *
 * @see Bible §4.8
...
import type { EnterstellarError } from '@enterstellar/types';
 ...
 */
export type LifecycleState = 'idle' | 'loading' | 'streaming' | 'ready' | 'error' | 'empty';
 ...
 * Vue, or DOM dependencies. `@enterstellar/react` wraps it in hooks.
 *
 * @see Bible §4.8
 * @see Design Choices LC1–LC9
 */
