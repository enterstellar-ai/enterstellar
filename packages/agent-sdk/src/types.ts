/**
 * @module @enterstellar/agent-sdk/types
 * @description SDK-local type definitions for the Agent SDK.
 *
 * Types defined here are internal to `@enterstellar/agent-sdk`. They define the
 ...
 *
 * @see Bible §4.16 — `@enterstellar/agent-sdk` MCP tools specification.
 ...
 *
 * Matches the subset of `EnterstellarRegistry` from `@enterstellar/registry` that the
 ...
 *
 * Matches the subset of `ComponentContract` from `@enterstellar/types` that
 ...
 *
 * Matches the subset of `EnterstellarCompiler` from `@enterstellar/compiler`.
 */
 ...
 *
 * Matches the subset of `SemanticIndex` from `@enterstellar/semantic-index`.
 */
 ...
 *
 * Matches the subset of `ComponentForge` from `@enterstellar/forge`.
 */
 ...
 *
 * Matches the subset of `EnterstellarStore` from `@enterstellar/state` used by
...
export interface EnterstellarAgentSDK {
   ...
   */
  buildUI(query: string, zones: readonly ZoneSpec[]): Promise<BuildUIResult>;
