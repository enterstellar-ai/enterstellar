/**
 * @module @enterstellar/agent-sdk/__tests__/tools/forge-component
...
import type { ForgeResult, ComponentContract, CompilationResult } from '@enterstellar/types';
...
describe('executeForgeComponent', () => {
  ...
  describe('constraint passthrough', () => {
    ...
    it('uses empty props when no constraints provided', async () => {
      ...
      expect(forge.forge).toHaveBeenCalledWith(expect.objectContaining({ props: {} }));
    });
  });
