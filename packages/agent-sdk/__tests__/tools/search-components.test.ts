/**
 * @module @enterstellar/agent-sdk/__tests__/tools/search-components
...
import type { SemanticSearchResult, ComponentContract } from '@enterstellar/types';
 ...
 */
function createMockIndex(results: readonly SemanticSearchResult[] = []): AgentSDKSemanticIndex {
  return {
...
describe('executeSearchComponents', () => {
  ...
  describe('error wrapping', () => {
    it('wraps semantic index errors in ENS-8002', async () => {
      ...
      await expect(executeSearchComponents(index, 'test query')).rejects.toThrow(EnterstellarError);
