/**
 * @module @enterstellar/agent-sdk/__tests__/tools/analyze-traces
 ...
 */
function createMockStore(traces: readonly Record<string, unknown>[] = []): AgentSDKStore {
  return {
...
describe('executeAnalyzeTraces', () => {
  ...
  describe('time range filtering', () => {
    it('returns all traces for timeRange "all"', async () => {
      const traces = [createTrace({ component: 'A' }), createTrace({ component: 'B' })];
