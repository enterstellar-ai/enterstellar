/**
 * @module @enterstellar/types/__tests__/errors
...
describe('EnterstellarError', () => {
  it('should create an error with all required properties', () => {
    const error = new EnterstellarError('ENS-1001', 'registry', 'Component is already registered.');
  ...
  it('should accept recoverable flag', () => {
    const error = new EnterstellarError('ENS-2001', 'compiler', 'Validation failed.', true);
  ...
  it('should produce a valid ISO 8601 timestamp', () => {
    const error = new EnterstellarError('ENS-1001', 'registry', 'test');
  ...
  describe('toJSON', () => {
    it('should serialize to a plain object with all fields', () => {
      const error = new EnterstellarError('ENS-4006', 'state', 'State exceeds 1MB.', true);
    ...
    it('should be JSON-serializable (no circular references)', () => {
      const error = new EnterstellarError('ENS-5001', 'cloud', 'Cloud endpoint unreachable.');
