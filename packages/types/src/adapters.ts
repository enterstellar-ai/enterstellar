/**
 * @module @enterstellar/types/adapters
 ...
 * defined here — implementations live in `@enterstellar/adapter-*` packages.
 *
 * @see Bible §3.6
...
export interface AuthAdapter {
   ...
   * ```
   */
  onAuthChange(callback: (session: { userId: string; roles: string[] } | null) => void): () => void;
}
