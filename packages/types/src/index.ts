 ...
 * `@enterstellar/types` — internal modules can import from specific files for
 * faster builds.
 *
...
// Design Tokens (§3.1b)
// ---------------------------------------------------------------------------
export type { DesignTokenSet, TokenResolverContext } from './token.js';
...
// Config (§3.5)
// ---------------------------------------------------------------------------
export type { ZoneConfig, ZoneCacheConfig } from './config.js';
export { ZoneConfigSchema } from './config.js';

// ---------------------------------------------------------------------------
// Adapters (§3.6)
// ---------------------------------------------------------------------------
export type { AuthAdapter, DataAdapter, ErrorAdapter, AnalyticsAdapter } from './adapters.js';

// ---------------------------------------------------------------------------
// Telemetry (§3.7)
// ---------------------------------------------------------------------------
export type { ForgeSignal, IntentCategory, ForgeMode, SignalPlatform } from './telemetry.js';
...
export { ZoneStateSchema, SessionStateSchema, SerializedStateSchema } from './state.js';

// ---------------------------------------------------------------------------
// Connection (§3.9–3.10)
// ---------------------------------------------------------------------------
export type { UserSignal, UserSignalType, AgentEventType } from './connection.js';
...
// Spatial Context (P13)
// ---------------------------------------------------------------------------
export type { SpatialContext, SpatialContextSnapshot } from './spatial.js';
...
// Forge (§4.10)
// ---------------------------------------------------------------------------
export type { ForgeResult, ForgeTraceRecord, ColdPathConfig } from './forge.js';
