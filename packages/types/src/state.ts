/**
 * @module @enterstellar/types/state
 ...
 * Implementations are provided by `@enterstellar/state` (`createEnterstellarStore()`).
 * React binding is provided by `@enterstellar/react` (`useEnterstellarStore()` hook via
