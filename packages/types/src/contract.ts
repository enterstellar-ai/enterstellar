/**
 * @module @enterstellar/types/contract
 ...
 * platform-specific renderer packages (`@enterstellar/react`, `@enterstellar/render-native`, etc.)
 ...
 * and internally by `@enterstellar/registry` during registration.
 *
