/**
 * @module @enterstellar/types/connection
 ...
 * @see Appendix E P1
 */
export type UserSignalType = 'click' | 'submit' | 'input' | 'custom';
 ...
 * @see Appendix E P7
 */
export type AgentEventType = 'intent' | 'lifecycle' | 'data' | 'message' | 'reconnect';
 ...
 * Transport-agnostic interface for bidirectional agent communication.
 *
 * Implementations are provided by `@enterstellar/connection` (`createAgentConnection()`)
