/**
 * @module @enterstellar/adapters/__tests__/create-analytics-adapter
...
} from '../src/create-analytics-adapter.js';
...
function createValidConfig(overrides?: Partial<AnalyticsAdapterConfig>): AnalyticsAdapterConfig {
  return {
    name: 'test-analytics',
    track: vi.fn(),
    identify: vi.fn(),
