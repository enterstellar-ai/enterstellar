/**
 * @module @enterstellar/cli/__tests__/templates
...
describe('generatePackageJson', () => {
  ...
  it('includes core deps in minimal template', () => {
    ...
    expect(deps['@enterstellar/react']).toBeDefined();
    expect(deps['@enterstellar/registry']).toBeDefined();
    expect(deps['zod']).toBeDefined();
    // Engine packages are transitive deps of @enterstellar/react (RE19, CLI4)
    expect(deps['@enterstellar/compiler']).toBeUndefined();
    expect(deps['@enterstellar/state']).toBeUndefined();
    expect(deps['@enterstellar/telemetry']).toBeUndefined();
  });
  ...
  it('includes DevTools in full template devDependencies', () => {
    ...
    expect(devDeps['@enterstellar/devtools']).toBeDefined();
    expect(devDeps['@enterstellar/test']).toBeDefined();
  });
...
describe('generateRegistry', () => {
  it('imports createRegistry', () => {
    ...
    expect(content).toContain("import { createRegistry } from '@enterstellar/registry'");
  });
