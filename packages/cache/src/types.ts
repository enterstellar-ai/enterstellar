/**
 * @module @enterstellar/cache/types
 ...
 */
export type EvictionReason = 'expired' | 'capacity' | 'manual' | 'component-update';
 ...
 * import `@enterstellar/compiler` directly — dependency injection keeps the
