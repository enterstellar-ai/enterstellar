/**
 * @module @enterstellar/devtools/__tests__/integration
 * @description Integration smoke tests for the `@enterstellar/devtools` module.
 *
...
// ---------------------------------------------------------------------------
// Mock @enterstellar/react — simulates EnterstellarStore trace subscription (DT7)
// ---------------------------------------------------------------------------
...
describe('DevTools Integration', () => {
  ...
  it('triggers JSON export download when export button is clicked', () => {
    mockStoreTraces = [createIntegrationTrace('int-export', { component: 'ExportTestComponent' })];
  ...
  it('handles full end-to-end flow: open → view traces → select → inspect → switch to validation', () => {
    mockStoreTraces = [createIntegrationTrace('flow-1', { component: 'FlowTest', status: 'fail' })];
