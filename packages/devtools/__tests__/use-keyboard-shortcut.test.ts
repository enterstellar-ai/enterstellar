/**
 * @module @enterstellar/devtools/use-keyboard-shortcut.test
...
import {
  ...
  matchesShortcut,
  useKeyboardShortcut,
} from '../src/use-keyboard-shortcut.js';
...
describe('useKeyboardShortcut', () => {
  ...
  it('uses the latest callback reference', () => {
    ...
    const { rerender } = renderHook(({ cb }) => useKeyboardShortcut('ctrl+shift+a', cb), {
