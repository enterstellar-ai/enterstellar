...
/**
 * @module @enterstellar/devtools/panels/replay-mode
...
export function ReplayMode(props: ReplayModeProps): React.JSX.Element {
  ...
  if (selectedTrace === null) {
    return (
      <div style={sharedPanelStyles['panelRoot']} data-enterstellar-devtools-panel="replay-mode">
        <div style={styles['emptyState']}>
          <span style={styles['emptyIcon']} role="img" aria-label="No trace selected">
            🔄
          </span>
          <span>Select a trace from the Timeline to replay its pipeline.</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={sharedPanelStyles['panelRoot']} data-enterstellar-devtools-panel="replay-mode">
      ...
      {/* Step List */}
      <div style={styles['stepList']} role="list" aria-label="Pipeline replay steps">
        {steps.map((step, index) => (
          <div key={step.name} style={styles['step']} role="listitem">
            {/* Step Indicator */}
            <div
              style={{
            ...
            {index === activeStep && (
              <div style={styles['stepBody']}>
                <JsonViewer data={step.data} label={step.label} defaultExpanded={true} />
              </div>
            )}
          </div>
        ))}
