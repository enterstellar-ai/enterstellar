...
/**
 * @module @enterstellar/devtools/components/filter-bar
...
export function FilterBar(props: FilterBarProps): React.JSX.Element {
  ...
  const handleSearchChange = useCallback(
    (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      if (filter.zone !== undefined) {
        (updated as Record<string, unknown>)['zone'] = filter.zone;
      }
      if (filter.component !== undefined) {
        (updated as Record<string, unknown>)['component'] = filter.component;
      }
      if (filter.status !== undefined) {
        (updated as Record<string, unknown>)['status'] = filter.status;
      }
      if (value.length > 0) {
        (updated as Record<string, unknown>)['search'] = value;
      }
  ...
  const handleZoneChange = useCallback(
    (event: React.ChangeEvent<HTMLSelectElement>) => {
      ...
      const updated: TraceFilter = Object.create(null) as TraceFilter;
      if (value.length > 0) {
        (updated as Record<string, unknown>)['zone'] = value;
      }
      if (filter.component !== undefined) {
        (updated as Record<string, unknown>)['component'] = filter.component;
      }
      ...
      if (filter.search !== undefined) {
        (updated as Record<string, unknown>)['search'] = filter.search;
      }
      onFilterChange(updated);
    },
    [filter, onFilterChange],
  ...
  const handleComponentChange = useCallback(
    (event: React.ChangeEvent<HTMLSelectElement>) => {
      ...
      if (value.length > 0) {
        (updated as Record<string, unknown>)['component'] = value;
      }
      if (filter.status !== undefined) {
        (updated as Record<string, unknown>)['status'] = filter.status;
      }
  ...
  const handleStatusClick = useCallback(
    (status: 'pass' | 'fail' | 'corrected') => {
      ...
      if (filter.status !== status) {
        (updated as Record<string, unknown>)['status'] = status;
      }
      if (filter.search !== undefined) {
        (updated as Record<string, unknown>)['search'] = filter.search;
      }
