/**
 * @module @enterstellar/telemetry/types
 * @description Module-internal types for the telemetry collector.
 *
 * These types define the public API surface of `@enterstellar/telemetry`.
...
import type { ForgeMode, IntentCategory, SignalPlatform } from '@enterstellar/types';
...
/**
 * The telemetry collector interface — the primary public API of `@enterstellar/telemetry`.
 *
 ...
 * 2. `record()` is called automatically by `@enterstellar/compiler` and `@enterstellar/react` (TL1).
