/**
 * @module @enterstellar/telemetry/create-telemetry
 * @description Async factory for creating a `TelemetryCollector`.
 *
 * This is the primary public API of `@enterstellar/telemetry`. It wires together:
...
export async function createTelemetryCollector(
  ...
  // we gracefully fall back to memory — matching @enterstellar/state's pattern
