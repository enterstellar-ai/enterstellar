...
**RE3 — Consumer manages connection:** The agent transport is not auto-created. You provide an `EnterstellarAgentConnection` (e.g., from `createAgentConnection()` in `@enterstellar/connection`) — or you don't, and the zones stay static.
